...
howItWorks:
  'HTML publications are used for:
  
    - publishing standalone government documents that are date-stamped and usually not updated once published
    
    - white papers, strategy documents and reports
  

  HTML publications will have a publication date and a reference number or ISBN number can be provided as well.'
